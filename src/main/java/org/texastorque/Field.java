...
public final class Field {
    ...
    public static final double FIELD_LENGTH = 16.541, FIELD_WIDTH = Units.inchesToMeters(315.5), SPEAKER_Y = 5.55,
            SPEAKER_X = 0, ANGLE_TO_LASER = 60, ALLIANCE_WING_LENGTH = 6, FAR_SIDE_SPEAKER_Y = 5.2, LASER_ADJUSTMENT = 1, LASER_SETPOINT = 38 * LASER_ADJUSTMENT, LASER_UNDER_STAGE = 20 * LASER_ADJUSTMENT;
