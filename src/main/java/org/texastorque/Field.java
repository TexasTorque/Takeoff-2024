...
public final class Field {
    ...
    public void updateAlliance() {
        ...
        speakerPoseAngleRight = new Pose2d(speakerXPosition, rightYPosition, Rotation2d.fromDegrees(0));
        speakerPoseAngleLeft = new Pose2d(speakerXPosition, leftYPosition, Rotation2d.fromDegrees(0));
    }
