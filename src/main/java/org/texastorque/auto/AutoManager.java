...
public final class AutoManager extends TorqueAutoManager implements Subsystems {
    ...
    public final void loadPaths() {
        ...
        pathLoader.preloadPath("go_SRC_to_30");
        pathLoader.preloadPath("go_40_to_50");
    }
    ...
    public final void loadSequences() {
        ...
        addBaseAuto("", StartPoint.CTR, NotePoint.N_2, NotePoint.N_30, NotePoint.N_40); 
        addBaseAuto("", StartPoint.SRC, NotePoint.N_30, NotePoint.N_40, NotePoint.N_50);
    ...
    private void addBaseAuto(final String extraTimePathName, final Location... notes) {
        ...
        addSequence(title, new BaseAuto(extraTimePathName, ns));
    }
